    ...
    <body>
        ...
        <header class="header header-sticky header-light" style="padding:10px 0">
            <nav class="navbar navbar-expand-lg yamm">
                <div class="container" style="display:flex;">
                    ...
                    <a class="navbar-brand" href="index.php">
                     <img src="assets/img/newLogo.png" style="top:0;aspect-ratio: auto;width: 10%;height:100%;" class="img-fluid logo-dark" alt="logo"> 
                    </a>
